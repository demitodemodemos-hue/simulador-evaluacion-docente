...
create table if not exists public.resultados (
  ...
  simulacro text not null default '2023-A01',
...
begin
  ...
  insert into public.resultados(
    participante_id, simulacro, modalidad, correctas, incorrectas, sin_responder,
    total, porcentaje, tiempo_segundos, escala, envio_automatico
  ) values (
    v_participante_id, coalesce(nullif(trim(p_simulacro),''),'2023-A01'), p_modalidad, p_correctas, p_incorrectas, p_sin_responder,
...
begin
  ...
  return query
  select r.id,r.fecha,p.id,p.nombre,p.correo,r.simulacro,r.modalidad,r.correctas,r.incorrectas,
